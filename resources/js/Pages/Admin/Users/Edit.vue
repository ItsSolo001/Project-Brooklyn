    ...
    <AdminLayout>
        ...
        <div class="max-w-7xl mx-auto mt-4">
            <div class="flex justify-between">
                <Link :href="route('users.index')" class="px-3 py-2 text-white font-semibold bg-indigo-500 hover:bg-indigo-600 rounded">Back</Link>
            </div>
        </div>
        <div class="max-w-6xl mx-auto mt-6 p-6 bg-slate-800">
        ...
        <div class="mt-6 max-w-6xl mx-auto bg-slate-800 shadow-lg rounded-lg p-6">
                <h1 class="text-2xl font-semibold text-center text-gray-400">Roles</h1>
        ...
        <div class="mt-6 max-w-6xl mx-auto bg-slate-800 shadow-lg rounded-lg p-6">
                <h1 class="text-2xl font-semibold text-center text-gray-400">Permissions</h1>
                <div class="bg-gray-900">
                    <Table>
                        <template #header>
                            <TableRow>  
