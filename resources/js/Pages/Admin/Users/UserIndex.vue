    ...
    <AdminLayout>
        <div class="max-w-7xl mx-auto py-4">
            <div class="flex justify-between">
                <h1 class="text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-gray-500 via-gray-600 to-gray-700 py-1">
                    Users Index Page
                </h1>

                <Link :href="route('users.create')" class="px-3 py-2 text-white font-semibold bg-indigo-500 hover:bg-indigo-700 rounded">New Users</Link>
            </div>
            <div class="mt-6">
                <Table>
                    <template #header>
                        ...
                        <TableRow v-for="user in users" :key="user.id" class="border-b">
                            ...
                            <TableDataCell class="space-x-4"> 
                                ...
                                <Modal :show="showConfirmDeleteUserModal" @close="closeModal">
                                    <div class="p-6">
                                        <h2 class="text-lg font-semibold text-slate-400">Are you sure to delete this user?</h2>
